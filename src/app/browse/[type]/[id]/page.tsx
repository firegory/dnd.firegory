...
import { ENTITY_CONFIG } from "../../../../server/entities/types";
...
export default async function EntityDetailPage({ params }: PageProps) {
  ...
  let classDetail: React.ReactNode = null;
  if (entity.entityType === "class" || entity.entityType === "species") {
    ...
    classDetail = <ClassDetailClient features={features} subclasses={subclasses} entityType={entity.entityType} />;
  }
