...
const translations = {
  ru: {
    ...
    close: "Закрыть",
    pageLevelPreviewNotice: "MVP показывает страницу целиком. Точный crop/highlight будет добавлен после ingest bbox.",
  ...
  en: {
    ...
    close: "Close",
    pageLevelPreviewNotice: "Page-level MVP preview. Precise crop/highlight will be added after bbox ingestion is available.",
