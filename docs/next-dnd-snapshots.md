...
Beginner-guide article selection is a separate plain-text review boundary documented in `docs/beginner-guides.md`. It creates cited pending #76 candidates from explicit normalized-text spans, omits `contentHtml`, and cannot publish collected markup.
